...
**EventBridge event schemas (manual):** `RollCompletedDetailSchema`, `RollRequestCompletedDetailSchema`, `PlayerLeftDetailSchema`, `PlayerJoinedDetailSchema`, `EventBridgeEventBodySchema`. These validate EventBridge payloads and are not in the GraphQL schema.
